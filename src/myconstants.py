# Frequently used column names, headers, and numeric constants
...
HEADER_ROLE_ASSIGNS = [LABEL_PLAYER_ID, LABEL_SESSION, LABEL_PLAYER_PERIOD, LABEL_ROLE_PERIOD, LABEL_BASE_ROLE]
...
FULL_HEADER_ROLE_ASSIGNS = [LABEL_ACTIVITY_ID] + HEADER_ROSTER + HEADER_ROLE_ASSIGNS[1:]
FULL_HEADER_FORM_PERIODS = [LABEL_ACTIVITY_ID] + HEADER_FORM_PERIODS
FULL_HEADER_ROLE_PERIODS = [LABEL_ACTIVITY_ID] + HEADER_ROLE_PERIODS
