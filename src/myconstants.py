...
HEADER_FORM_PERIODS = [
    LABEL_FORM_PERIOD, LABEL_SESSION, LABEL_START_DT, LABEL_END_DT,
    LABEL_DURATION, LABEL_COORDS, LABEL_EDGE_MAT
]
HEADER_ROLE_PERIODS = [
    LABEL_FORM_PERIOD, LABEL_ROLE_PERIOD, LABEL_SESSION, 
    LABEL_START_DT, LABEL_END_DT, LABEL_DURATION, LABEL_BASE_PERM
]
HEADER_ROLE_ALIGNS = [LABEL_ACTIVITY_ID, LABEL_FORM_PERIOD, LABEL_BASE_ROLE, LABEL_ALIGNED_ROLE]
HEADER_ROLE_RECORDS = [
