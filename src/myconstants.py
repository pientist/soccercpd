...
HEADER_FGP = [
    LABEL_PLAYER_ID, LABEL_SESSION, LABEL_GAMETIME, LABEL_PLAYER_PERIOD, LABEL_FORM_PERIOD, LABEL_ROLE_PERIOD,
    LABEL_X, LABEL_Y, LABEL_X_NORM, LABEL_Y_NORM, LABEL_ROLE, LABEL_BASE_ROLE, LABEL_SWITCH_RATE
]
...
HEADER_FORM_PERIOD_RECORDS = [LABEL_SESSION, LABEL_FORM_PERIOD, LABEL_START_DT, LABEL_END_DT,
                              LABEL_DURATION, LABEL_COORDS, LABEL_EDGE_MAT]
HEADER_ROLE_PERIOD_RECORDS = [LABEL_SESSION, LABEL_FORM_PERIOD, LABEL_ROLE_PERIOD,
                              LABEL_START_DT, LABEL_END_DT, LABEL_DURATION, LABEL_BASE_PERM]
HEADER_ROLE_ASSIGN_RECORDS = [LABEL_PLAYER_ID, LABEL_SESSION, LABEL_PLAYER_PERIOD, LABEL_ROLE_PERIOD, LABEL_BASE_ROLE]

HEADER_PLAYER_META = [LABEL_ACTIVITY_ID, LABEL_DATE, LABEL_TEAM_NAME] + HEADER_ROSTER
FULL_HEADER_FORM_PERIOD_RECORDS = [LABEL_ACTIVITY_ID] + HEADER_FORM_PERIOD_RECORDS
FULL_HEADER_ROLE_RECORDS = [LABEL_ACTIVITY_ID] + HEADER_ROLE_RECORDS
FULL_HEADER_ROLE_PERIOD_RECORDS = [LABEL_ACTIVITY_ID] + HEADER_ROLE_PERIOD_RECORDS
FULL_HEADER_ROLE_ASSIGN_RECORDS = [LABEL_ACTIVITY_ID] + HEADER_ROSTER + HEADER_ROLE_ASSIGN_RECORDS[1:]
...
FREQ_GPS_SEC = 0.1
FREQ_GPS = str(FREQ_GPS_SEC) + 'S'
FREQ_OCH_SEC = 0.5
FREQ_OCH = str(FREQ_OCH_SEC) + 'S'
